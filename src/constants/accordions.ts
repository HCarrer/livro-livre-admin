...
const DONATE: AccordionProps = {
  ...
  content:
    "Para doar um livro basta se dirigir a estante mais próxima e deixar sua doação no local designado.",
};

export const ACCORDIONS: AccordionProps[] = [RENT, RETURN, DONATE];
